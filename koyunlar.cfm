...
<body>
    ...
    <div class="content">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            ...
                            Koyunlar <span class="caret"></span>
                        </a>
        ...
        <h1>Koyunlar Tablosu</h1>


        <button id="kaydetBtn">Kaydet</button>

        <div id="kaydetForm" style="display: none;">
            <form action="veritabanimportkoyun.cfm" method="POST" enctype="multipart/form-data">
            ...
            <form  action="koyunlar.cfm" method="post">
                ...
                <table id="hayvanTablosu" class="hayvan-tablosu" name="kayittablo">
                    ...
                    <cfoutput query="getHayvanlar">
                        <tr>
                            ...
                            <td><a href="koyunlar.cfm?HayvanAdi=#HayvanAdi#"><button class="silBtn" onclick="refreshPage()">Sil</button></a></td>
                        </tr>
                    </cfoutput>
...
<cfif url.HayvanAdi neq "">
    <cfquery name="qDelete" datasource="workCubeDSN">
        DELETE FROM Koyunlar WHERE HayvanAdi = <cfqueryparam value="#url.HayvanAdi#" cfsqltype="cf_sql_varchar">
    </cfquery>
</cfif>

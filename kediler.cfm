...
<body>
    ...
    <div class="content">
        ...
        <h1>Kediler tablosu</h1>


        <button id="kaydetBtn">Kaydet</button>

        <div id="kaydetForm" style="display: none;">
            <form action="veritabanimportkedi.cfm" method="POST" enctype="multipart/form-data">
            ...
            <form  action="kediler.cfm" method="post">
...
<cfset tarih = form.tarih>
    ...
    <cfquery  datasource="workCubeDSN">
        INSERT INTO  Kediler (HayvanTuru, CinsAdi, HayvanAdi, YemMiktari, MuayeneTarihi)
        VALUES (
                ...
                <table id="hayvanTablosu" class="hayvan-tablosu" name="kayittablo">
                    ...
                    <cfoutput query="getHayvanlar">
                        <tr>
                            ...
                            <td><a href="kediler.cfm?HayvanAdi=#HayvanAdi#"><button class="silBtn" onclick="refreshPage()">Sil</button></a></td>
                        </tr>
                    </cfoutput>
...
<cfif url.HayvanAdi neq "">
    <cfquery name="qDelete" datasource="workCubeDSN">
        DELETE FROM Kediler WHERE HayvanAdi = <cfqueryparam value="#url.HayvanAdi#" cfsqltype="cf_sql_varchar">
    </cfquery>
</cfif>

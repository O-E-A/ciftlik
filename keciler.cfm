...
<body>
    ...
    <div class="content">
        ...
        <div id="kaydetForm" style="display: none;">
            <form action="veritabanimportkeci.cfm" method="POST" enctype="multipart/form-data">
            ...
            <form  action="keciler.cfm" method="post">
                ...
                <input type="number" id="sutMiktari" name="sutMiktari" placeholder="Süt Miktarı (lt/gün)" required>
                <input type="date" name="tarih" name="tarih" value="<cfoutput>#DateFormat(now(), 'yyyy-mm-dd')#</cfoutput>">
                <button type="submit" class="btn btn-primary">Oluştur</button>
            </form>
        </div>

<cfif structKeyExists(form, "hayvanTuru") AND structKeyExists(form, "cinsAdi") AND structKeyExists(form, "hayvanAdi") AND structKeyExists(form, "yemMiktari") AND structKeyExists(form, "sutMiktari") AND structKeyExists(form, "tarih")>

<cfset hayvanTuru = form.hayvanTuru>
<cfset cinsAdi = form.cinsAdi>
<cfset hayvanAdi = form.hayvanAdi>
<cfset yemMiktari = form.yemMiktari>
<cfset sutMiktari = form.sutMiktari>
<cfset tarih = form.tarih>

    <cfquery  datasource="workCubeDSN">
        INSERT INTO  Keciler (HayvanTuru, CinsAdi, HayvanAdi, YemMiktari, SutMiktari, MuayeneTarihi)
        VALUES (
            ...
            <cfqueryparam value="#sutMiktari#" cfsqltype="cf_sql_integer">,
                ...
                <table id="hayvanTablosu" class="hayvan-tablosu" name="kayittablo">
                    ...
                    <cfoutput query="getHayvanlar">
                        <tr>
                            ...
                            <td><a href="keciler.cfm?HayvanAdi=#HayvanAdi#"><button class="silBtn" onclick="refreshPage()">Sil</button></a></td>
                        </tr>
                    </cfoutput>
...
<cfif url.HayvanAdi neq "">
    <cfquery name="qDelete" datasource="workCubeDSN">
        DELETE FROM Keciler WHERE HayvanAdi = <cfqueryparam value="#url.HayvanAdi#" cfsqltype="cf_sql_varchar">
    </cfquery>
</cfif>

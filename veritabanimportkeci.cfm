<cfif isDefined('form.submitted') and len(form.submitted)>
    <cfif structKeyExists(form, "dosya") AND form.dosya neq "">
        ...
        <cfif isDefined("dosya")>
            ...
            <cfset excelData = []>
            <cfspreadsheet action="read" src="C:\ColdFusion2021\cfusion\wwwroot\ciftlik\yukleme\yuklemekeci.xlsx" query="excelData" headerrow="1">
            ...
            <cflocation url="keciler.cfm" addtoken="false">
